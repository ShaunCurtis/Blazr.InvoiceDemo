...
public sealed class InvoiceTestDataProvider
{
    ...
    private void LoadInvoices()
    {
        ...
        {
            new() { Uid=Guid.NewGuid(), CustomerUid = _customers![Random.Shared.Next(Customers.Count())].Uid, InvoiceDate = DateOnly.FromDateTime(DateTime.Now), InvoiceNumber="1001"},
            new() { Uid=Guid.NewGuid(), CustomerUid = _customers![Random.Shared.Next(Customers.Count())].Uid, InvoiceDate = DateOnly.FromDateTime(DateTime.Now), InvoiceNumber="1002"},
            new() { Uid=Guid.NewGuid(), CustomerUid = _customers![Random.Shared.Next(Customers.Count())].Uid, InvoiceDate = DateOnly.FromDateTime(DateTime.Now), InvoiceNumber="1003"},
        };
        _invoices = invoices;
    }
