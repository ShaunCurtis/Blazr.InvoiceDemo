...
public sealed class SaveRequestServerHandler<TDbContext>
    : ISaveRequestHandler
    where TDbContext : DbContext
{
    private readonly IServiceProvider _serviceProvider;
    private readonly SaveRequestBaseServerHandler<TDbContext> _baseHandler;

    public SaveRequestServerHandler(IServiceProvider serviceProvider, SaveRequestBaseServerHandler<TDbContext> baseHandler)
    { 
        ...
        where TRecord : class, new()
    {
        ...
        var _customHandler = ActivatorUtilities.GetServiceOrCreateInstance<ISaveRequestHandler<TRecord>>(_serviceProvider);
