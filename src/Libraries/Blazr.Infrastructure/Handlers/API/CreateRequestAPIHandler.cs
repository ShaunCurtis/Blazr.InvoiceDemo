...
public sealed class CreateRequestAPIHandler
    : ICreateRequestHandler
{
    private IHttpClientFactory _factory;

    public CreateRequestAPIHandler(IHttpClientFactory factory)
        => _factory = factory;
        ...
        where TRecord : class, new()
    {
        ...
        //TODO - security
        var response = await httpClient.PostAsJsonAsync<CommandRequest<TRecord>>($"/api/{entityname}/addrecordcommand", request, request.Cancellation);
