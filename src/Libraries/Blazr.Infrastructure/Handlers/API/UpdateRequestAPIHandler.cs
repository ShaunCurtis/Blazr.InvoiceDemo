...
public sealed class UpdateRequestAPIHandler
    : IUpdateRequestHandler
{
    private IHttpClientFactory _factory;

    public UpdateRequestAPIHandler(IHttpClientFactory factory)
        => _factory = factory;
        ...
        where TRecord : class, new()
    {
        ...
        //TODO - security
        var response = await httpClient.PostAsJsonAsync<CommandRequest<TRecord>>($"/api/{entityname}/updaterecordcommand", request, request.Cancellation);
